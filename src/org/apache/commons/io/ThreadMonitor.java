...
class ThreadMonitor implements Runnable {
    ...
    /**
     * Sleep until the specified timeout amount and then interrupt the thread
     * being monitored.
     *
     * @see Runnable#run()
     */
     ...
     * 200ms or anything else it deems appropriate. Read the docs on
     * Thread.sleep for further interesting details.
     *
     * @
