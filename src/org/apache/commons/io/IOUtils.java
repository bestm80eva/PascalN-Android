...
public class IOUtils {
     ...
     * be present for the non-exceptional case.</b>
     * <br>
    ...
    /**
     * Gets the contents of a <code>Reader</code> as a <code>byte[]</code> using
    ...
    /**
     * Gets the contents of a <code>String</code> as a <code>byte[]</code> using
     * the default character encoding of the platform.
     * <p>
    ...
    /**
     * Gets the contents of a <code>byte[]</code> as a String using the
     * specified character encoding.
     * <p>
     * Character encoding names can be found at
     * <a href="http://www.iana.org/assignments/character-sets">IANA</a>.
    ...
    /**
     * Gets the contents of a <code>Reader</code> as a list of Strings, one
     * entry per line.
     * <p>
     * This method buffers the input internally, so there is no need to use a
     * <code>BufferedReader</code>.
    ...
    //-----------------------------------------------------------------------
    /**
     * Converts the specified string to an input stream, encoded as bytes using
     * the default character encoding of the platform.
     *
     ...
     * @since 1.1
     * @deprecated 2.5 use
     * {@link #writeLines(Collection, String, OutputStream, Charset)} instead
     */
    @Deprecated
    ...
    /**
     * Copies some or all chars from a large (over 2GB) <code>InputStream</code>
     ...
     * @param input the <code>Reader</code> to read from
     * @param output the <code>OutputStream</code> to write to
     * @param outputEncoding the encoding to use for the OutputStream, null
