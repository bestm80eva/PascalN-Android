...
public class BoundedReader
     ...
     * @param maxCharsFromTargetReader The maximum number of characters that can
     * be read from target
     ...
     * still retaining the ability to do #reset(). Note that this parameter is
     * not validated with respect to maxCharsFromTargetReader. There is no way
     * to pass past maxCharsFromTargetReader, even if this value is greater.
     *
     * @throws IOException If an I/O error occurs while calling the underlying
